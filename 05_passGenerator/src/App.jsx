...
function App() {
  ...
  const PasswordGenerator = useCallback(() => {
    ...
    //setPassword is used for memoisation (basically for optimisation)
    ...
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button
            onClick={
              password.length > 0 ? copyPasswordToClipboard : PasswordGenerator
            }
            className="oultine-none bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:text-green-500"
          >
            Copy
          </button>
        </div>
